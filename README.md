...
1. Browser: http://localhost:3000/api/works
2. NextJS server: /api/works --> proxy to https://js-post-api.herokuapp.com/api/works
3. API server: https://js-post-api.herokuapp.com/api/works
